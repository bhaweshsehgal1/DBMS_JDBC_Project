...
public class jdbcdemo2 {
   ...
   public static void main (String args []) throws SQLException {
    try
    {
        ...
        Connection conn = ds.getConnection("bsehgal1", "9212367502");

	//created switch statement for implementing diffrent cases
	...
	System.out.println("enter 6 for displaying name name of the customer as well as every purchase the  the customer has made for given cid");
